        ...
        <svg  :class="{ 'hidden': $store.quality.qualitySwitch === 'webp-bw' }" width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 1440 920" fill="none"
          xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              fill="#8CFDCC" />
            <mask id="mask0_202_5603" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="-138"
              y="-95" width="661" height="692">
              <path
            ...
            <path
              ...
              fill="#8CFDCC" />
            <mask id="mask1_202_5603" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="349"
              y="-57" width="1420" height="1302">
              <path
